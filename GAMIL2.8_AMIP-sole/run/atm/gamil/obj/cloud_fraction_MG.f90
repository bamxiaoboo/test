# 1 "/data3/work/yuxinzhu/test/model_platform/models/atm/GAMIL2.8_AMIP/src/physics/cam1/cloud_fraction_MG.F90"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/data3/work/yuxinzhu/test/model_platform/models/atm/GAMIL2.8_AMIP/src/physics/cam1/cloud_fraction_MG.F90"
module cloud_fraction_MG
    ...
    real(r8), parameter :: rhminl = 0.915_r8          ! minimum rh for low stable clouds (.915_r8)
...
# 1 "./misc.h" 1
# 64 "/data3/work/yuxinzhu/test/model_platform/models/atm/GAMIL2.8_AMIP/src/physics/cam1/cloud_fraction_MG.F90" 2
...
!                    strat = min(1.0_r8, max(0.0_r8, ocnfrac(i)*((theta(i,k700)-thetas(i))*0.057_r8-0.5573_r8)))
                    strat = min(1.0_r8, max(0.0_r8, 2.0_r8*ocnfrac(i)*((theta(i,k700)-thetas(i))*0.057_r8-0.5573_r8)))   !20110218
                    !
