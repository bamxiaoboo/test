# 1 "/data3/work/yuxinzhu/test/model_platform/models/libs/shr/shr_file_mod.F90"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/data3/work/yuxinzhu/test/model_platform/models/libs/shr/shr_file_mod.F90"
!===============================================================================
! CVS $Id: shr_file_mod.F90,v 1.2 2003/11/22 00:27:08 tcraig Exp $
...
!     call shr_sys_system(trim(cmd),rcode)
      write(6,*) 'It may not work on Linux cluster, qbao'
!qbao
