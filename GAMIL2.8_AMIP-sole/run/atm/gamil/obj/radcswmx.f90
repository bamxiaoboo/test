# 1 "/data3/work/yuxinzhu/test/model_platform/models/atm/GAMIL2.8_AMIP/src/physics/cam1/radcswmx.F90"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/data3/work/yuxinzhu/test/model_platform/models/atm/GAMIL2.8_AMIP/src/physics/cam1/radcswmx.F90"

# 1 "./misc.h" 1
# 2 "/data3/work/yuxinzhu/test/model_platform/models/atm/GAMIL2.8_AMIP/src/physics/cam1/radcswmx.F90" 2

# 1 "./params.h" 1
# 3 "/data3/work/yuxinzhu/test/model_platform/models/atm/GAMIL2.8_AMIP/src/physics/cam1/radcswmx.F90" 2
...
subroutine radcswmx(lchnk   ,ncol    ,                            &
                    ...
                    fsutoa  ,fsdtoa) ! added by Li Dong 2012-02-15
!-----------------------------------------------------------------------
!
! Purpose:
...
# 140 "/data3/work/yuxinzhu/test/model_platform/models/atm/GAMIL2.8_AMIP/src/physics/cam1/radcswmx.F90" 2
!
! Input arguments
!
...
!
   ...
   real(r8), intent(out) :: fsus(pcols)      ! short wave upward flux at surface, added by Li Dong
!
...
!
   ...
   real(r8) wexptdn          ! Direct solar beam trans. to surface
    ...
    ! added by Li Dong
    real(r8) fsutoa(pcols)  ! short wave up at top of atmosphere
    real(r8) fsdtoa(pcols)  ! short wave down at top of atmosphere
...
!
      ...
      fsutoa(i)  = 0.0_r8 ! added by Li Dong 2012-02-15
      fsdtoa(i)  = 0.0_r8 !
...
# 883 "/data3/work/yuxinzhu/test/model_platform/models/atm/GAMIL2.8_AMIP/src/physics/cam1/radcswmx.F90"
...
!
            ...
            fsutoa(i) = fsutoa(i)+solflx*fluxup(0) ! added by Li Dong
            fsdtoa(i) = fsdtoa(i)+solflx*fluxdn(0) !
