# 1 "/data3/work/yuxinzhu/test/model_platform/models/libs/shr/shr_timer_mod.F90"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/data3/work/yuxinzhu/test/model_platform/models/libs/shr/shr_timer_mod.F90"
!===============================================================================
! CVS: $Id: shr_timer_mod.F90,v 1.2.34.1 2006/01/26 22:25:58 kauff Exp $
...
module shr_timer_mod
   ...
   !
   ! * cpp if-defs were introduced in 2006 to work-around a bug in the ORNL Cray
...
!-------------------------------------------------------------------------------
   ...
   if (cycles /= 0) then
     clock_rate = 1.0/REAL(cycles,KIND=SHR_KIND_R8)
   else
     clock_rate = 0
