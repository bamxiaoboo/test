# 1 "/data3/work/yuxinzhu/test/model_platform/models/atm/GAMIL2.8_AMIP/src/lnd/clm2/src/biogeophys/CombineSnowLayers.F90"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/data3/work/yuxinzhu/test/model_platform/models/atm/GAMIL2.8_AMIP/src/lnd/clm2/src/biogeophys/CombineSnowLayers.F90"

# 1 "./misc.h" 1
# 2 "/data3/work/yuxinzhu/test/model_platform/models/atm/GAMIL2.8_AMIP/src/lnd/clm2/src/biogeophys/CombineSnowLayers.F90" 2
...
# 3 "/data3/work/yuxinzhu/test/model_platform/models/atm/GAMIL2.8_AMIP/src/lnd/clm2/src/biogeophys/CombineSnowLayers.F90" 2
...
!
!-----------------------------------------------------------------------
! $Id: CombineSnowLayers.F90,v 1.1.10.3 2002/06/15 13:50:14 erik Exp $
!-----------------------------------------------------------------------
...
!
! The liquid water is assumed to pond on soil surface.
!
