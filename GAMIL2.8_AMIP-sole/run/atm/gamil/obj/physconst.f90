# 1 "/data3/work/yuxinzhu/test/model_platform/models/atm/GAMIL2.8_AMIP/src/physics/cam1/physconst.F90"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/data3/work/yuxinzhu/test/model_platform/models/atm/GAMIL2.8_AMIP/src/physics/cam1/physconst.F90"
module physconst
...
!
!  sxj add for zhang_cam3.5^M
   real(r8), public, parameter :: cpliq = shr_const_cpfw    ! specific heat of fresh h2o (J/K/kg)^M
   real(r8), public, parameter :: rwat  = shr_const_rwv     ! Water vapor gas constant (J/K/kg)
