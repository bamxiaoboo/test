# 1 "/data3/work/yuxinzhu/test/model_platform/models/atm/GAMIL2.8_AMIP/src/utils/fft99.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/data3/work/yuxinzhu/test/model_platform/models/atm/GAMIL2.8_AMIP/src/utils/fft99.F"

# 1 "./misc.h" 1
# 2 "/data3/work/yuxinzhu/test/model_platform/models/atm/GAMIL2.8_AMIP/src/utils/fft99.F" 2

# 1 "./params.h" 1
# 3 "/data3/work/yuxinzhu/test/model_platform/models/atm/GAMIL2.8_AMIP/src/utils/fft99.F" 2
...
C-----------------------------------------------------------------------
c
c $Id: fft99.F,v 1.4 2001/03/05 19:51:37 erik Exp $
c $Author: erik $
c
      DIMENSION A(LOT* (N+2) ),WORK(LOT*(N+1)),TRIGS(3*N/2+1),IFAX(13)
C
