...
#ifdef COSP
                    lengath ,ql      ,ptendlaq  ,ptendlat, ccrain, ccsnow)
#else
...
#ifdef COSP
    real(r8), intent(inout) :: ccrain(pcols,pver), ccsnow(pcols,pver)
    integer kk
#endif
!
!-----------------------------------------------------------------------
      ...
      do i = 1,ncol
        ...
        do i = 1, ncol
            if (ts(i) >= tfreez) then
                do k = msg+1, pver
                    do kk = k, pver
                        ccrain(i,kk) = ccrain(i,kk)+pcpck(i,k)
                    end do
                end do
            else
                do k = msg+1, pver
                    do kk = k, pver
                        ccsnow(i,kk) = ccsnow(i,kk)+pcpck(i,k)
                    end do
                end do
            end if
        end do
