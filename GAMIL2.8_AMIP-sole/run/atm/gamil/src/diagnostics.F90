...
#ifdef COSP
        ! ======================================================================
        ! output model layers for COSP
        call outfld("PMID    ", state%pmid, pcols, lchnk)
        call outfld("PINT    ", state%pint(:,2:pverp), pcols, lchnk)
        call outfld("ZMID    ", state%zm, pcols, lchnk)
        call outfld("ZINT    ", state%zi(:,2:pverp), pcols, lchnk)
