...
!-----------------------------------------------------------------------
   ...
   return
end subroutine cmip5nl_ghg

!##############################################################################

subroutine cmip5_ghg
!----------------------------------------------------------------------- 
! 
! Purpose: 
...
#ifdef CO2_TIMES_4
    if (masterproc) write(6, *) "Li Dong: CO2x4"
    co2vmr = co2vmr*4.0
#endif
