# 1 "/data3/work/yuxinzhu/test/model_platform/models/libs/esmf/src/Infrastructure/TimeMgmt/ESMF_DateMod.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/data3/work/yuxinzhu/test/model_platform/models/libs/esmf/src/Infrastructure/TimeMgmt/ESMF_DateMod.F"
! $Id: ESMF_DateMod.F,v 1.1.2.5 2002/04/25 17:14:52 dneckels Exp $
	module ESMF_DateMod
!===============================================================================
!BOP
! !MODULE: ESMF_DateMod
...
! !DESCRIPTION:
!     Initializes a {\tt ESMF\_Date} object. \!     See the explicit interfaces:

!
!     \begin{tabular}{p{2in}p{3.5in}}
!     {\tt ESMF\_DateInitIS}          & initializes a date based on integer seconds \!     {\tt ESMF\_DateInitUndefined}   & initializes a date with undefined contents \!     {\tt ESMF\_DateCopyInit}        & initializes a date based on another date \!     \end{tabular}  
...
! !DESCRIPTION:
!     Sets the attributes of a {\tt ESMF\_Date} object. \!     See the explicit interfaces:

!
!     \begin{tabular}{p{2in}p{3.5in}}
!     {\tt ESMF\_DateSetIS}  & sets a date based on integer seconds \!     \end{tabular}  
...
! !DESCRIPTION:
!     Gets the attributes of a {\tt ESMF\_Date} object. \!     See the explicit interfaces:

!
!     \begin{tabular}{p{2in}p{3.5in}}
!     {\tt ESMF\_DateGetIS} & gets the value of a date based on integer seconds \!     \end{tabular}  
