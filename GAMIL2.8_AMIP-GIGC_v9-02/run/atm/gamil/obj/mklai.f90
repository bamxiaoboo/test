# 1 "/data3/work/yuxinzhu/test/model_platform/models/atm/GAMIL2.8_AMIP/src/lnd/clm2/src/mksrfdata/mklai.F90"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/data3/work/yuxinzhu/test/model_platform/models/atm/GAMIL2.8_AMIP/src/lnd/clm2/src/mksrfdata/mklai.F90"

# 1 "./misc.h" 1
# 2 "/data3/work/yuxinzhu/test/model_platform/models/atm/GAMIL2.8_AMIP/src/lnd/clm2/src/mksrfdata/mklai.F90" 2
...
# 3 "/data3/work/yuxinzhu/test/model_platform/models/atm/GAMIL2.8_AMIP/src/lnd/clm2/src/mksrfdata/mklai.F90" 2
...
! 
!-----------------------------------------------------------------------
! $Id: mklai.F90,v 1.2.10.4 2002/08/28 15:41:15 erik Exp $
!-----------------------------------------------------------------------
...
! ------------------------ local variables ------------------------
  ...
  real(r8), allocatable :: mlai_o(:,:,:)      !monthly lai out
  real(r8), allocatable :: msai_o(:,:,:)      !monthly sai out
  real(r8), allocatable :: mhgtt_o(:,:,:)     !monthly height (top) out
  real(r8), allocatable :: mhgtb_o(:,:,:)     !monthly height (bottom) out
...
! -----------------------------------------------------------------
  ...
  allocate(mlai_o(lsmlon,lsmlat,0:numpft), stat=ier) 
  if (ier/=0) call endrun
  allocate(msai_o(lsmlon,lsmlat,0:numpft), stat=ier) 
  if (ier/=0) call endrun
  allocate(mhgtt_o(lsmlon,lsmlat,0:numpft), stat=ier)
  if (ier/=0) call endrun
  allocate(mhgtb_o(lsmlon,lsmlat,0:numpft), stat=ier)
  if (ier/=0) call endrun
