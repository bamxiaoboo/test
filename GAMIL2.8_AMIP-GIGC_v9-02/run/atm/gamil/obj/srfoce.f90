# 1 "/data3/work/yuxinzhu/test/model_platform/models/atm/GAMIL2.8_AMIP/src/ocnsice/dom/srfoce.F90"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/data3/work/yuxinzhu/test/model_platform/models/atm/GAMIL2.8_AMIP/src/ocnsice/dom/srfoce.F90"

# 1 "./misc.h" 1
# 2 "/data3/work/yuxinzhu/test/model_platform/models/atm/GAMIL2.8_AMIP/src/ocnsice/dom/srfoce.F90" 2

# 1 "./params.h" 1
# 3 "/data3/work/yuxinzhu/test/model_platform/models/atm/GAMIL2.8_AMIP/src/ocnsice/dom/srfoce.F90" 2
...
# 36 "/data3/work/yuxinzhu/test/model_platform/models/atm/GAMIL2.8_AMIP/src/ocnsice/dom/srfoce.F90" 2
    ...
    call flxoce(indx    ,npts    ,pmidm1  ,ubot    ,vbot      , &
                ...
                lwup    ,tref    ,wind10m)
    call outfld("WIND10M", wind10m, pcols, lchnk)
    !
