# 1 "/data3/work/yuxinzhu/test/model_platform/models/atm/GAMIL2.8_AMIP/src/control/history.F90"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/data3/work/yuxinzhu/test/model_platform/models/atm/GAMIL2.8_AMIP/src/control/history.F90"

# 1 "./misc.h" 1
# 2 "/data3/work/yuxinzhu/test/model_platform/models/atm/GAMIL2.8_AMIP/src/control/history.F90" 2

# 1 "./params.h" 1
# 3 "/data3/work/yuxinzhu/test/model_platform/models/atm/GAMIL2.8_AMIP/src/control/history.F90" 2

! Modificiation record:
!
!   2003-05-19  <WAN Hui> with unknown purpose
!   2005-01-28  <WAN Hui> for ISCCP Cloud Simulator
...
! Purpose:
!
!   contains data and functions for writing history files.
!
...
!
!-----------------------------------------------------------------------
! $Id: history.F90,v 1.26.2.20 2002/09/25 04:29:55 erik Exp $
!-----------------------------------------------------------------------
...
!
   ...
   character(len=20)  :: logname             ! user name
...
!
   character(len=256) :: ifilename_spec = "%c.gamil.i.%y-%m-%d-%s.nc"  ! Initial files
   character(len=256) :: rhfilename_spec = "%c.gamil.rh%t.%y-%m-%d-%s" ! history restart
...
!
      if ( masterproc )then
         ...
         if (logname=="        ") then
            write(6,*)"PARSE_NAMELIST: Cannot find HOME environment variable"
            call endrun
         end if
         host = " "
...
# 631 "/data3/work/yuxinzhu/test/model_platform/models/atm/GAMIL2.8_AMIP/src/control/history.F90"
                  else
...
# 670 "/data3/work/yuxinzhu/test/model_platform/models/atm/GAMIL2.8_AMIP/src/control/history.F90"
            end do
            if (masterproc) then
               close (unit=luhrest)
...
# 700 "/data3/work/yuxinzhu/test/model_platform/models/atm/GAMIL2.8_AMIP/src/control/history.F90" 2
!-----------------------------------------------------------------------
!
! Arguments
!
      ...
      do t=1,mtapes
         do f=1,nflds(t)
            ...
            case (dyn_decomp)
               ...
               if ( dycore_is("LR") )then
# 835 "/data3/work/yuxinzhu/test/model_platform/models/atm/GAMIL2.8_AMIP/src/control/history.F90"
               else
                  tape(t)%hlist(f)%field%begver = 1
                  tape(t)%hlist(f)%field%endver = numlev
               endif
...
!
            do f=1,nflds(t)
               ...
               case (dyn_decomp)
                  if ( dycore_is("LR") )then
# 957 "/data3/work/yuxinzhu/test/model_platform/models/atm/GAMIL2.8_AMIP/src/control/history.F90"
                  else
...
# 993 "/data3/work/yuxinzhu/test/model_platform/models/atm/GAMIL2.8_AMIP/src/control/history.F90"
            end do
!
...
!!    real(r8) divdampn         ! Number of days to invoke divergence damper
      real(r8) precc_thresh     ! Precipitation threshold for PRECCINT and PRECCFRQ
      real(r8) precl_thresh     ! Precipitation threshold for PRECLINT and PRECLFRQ
# 1090 "/data3/work/yuxinzhu/test/model_platform/models/atm/GAMIL2.8_AMIP/src/control/history.F90" 2
!---------------------------Local variables-----------------------------
!
      integer t, f                   ! tape, field indices
...
!
# 1396 "/data3/work/yuxinzhu/test/model_platform/models/atm/GAMIL2.8_AMIP/src/control/history.F90"
...
# 1481 "/data3/work/yuxinzhu/test/model_platform/models/atm/GAMIL2.8_AMIP/src/control/history.F90"
...
!!    real(r8) divdampn         ! Number of days to invoke divergence damper
      real(r8) precc_thresh     ! Precipitation threshold for PRECCINT and PRECCFRQ
      real(r8) precl_thresh     ! Precipitation threshold for PRECLINT and PRECLFRQ
# 1820 "/data3/work/yuxinzhu/test/model_platform/models/atm/GAMIL2.8_AMIP/src/control/history.F90" 2
...
!!
      ...
      do m=3,pcnst+pnats     !sxj ---------------2008-11-12
         ...
         if ((cnst_name(m)=="NUMLIQ").or.(cnst_name(m)=="NUMICE")) then   ! sxj---
            call add_default (cnst_name(m), 1, " ")
            call add_default (sflxnam(m),   1, " ")
         endif
      enddo
...
!! ( wanhui 2003.06.19)
            ...
            call add_default("U200    ", 1, " ")  ! added by SHI Xiangjun
...
!!
   ...
   if (ideal_phys) then
      ...
      call add_default ("T       ", 2, "I")
      call add_default ("U       ", 2, "I")
      call add_default ("PS      ", 2, "I")

   elseif (adiabatic) then

      call add_default ("PS      ", 2, "I")
      call add_default ("T       ", 2, "I")
      call add_default ("U       ", 2, "I")
      call add_default ("V       ", 2, "I")
      call add_default ("Z3      ", 2, "I")
      call add_default ("Z500    ", 2, "I")

      do m=1,pcnst+pnats
         call add_default (cnst_name(m), 2, "I")
      end do
...
!      call add_default ("PRECL   ", 2, " ")
!      call add_default ("PRECC   ", 2, " ")
!      call add_default ("TS      ", 2, " ")
...
!!    real(r8) divdampn         ! Number of days to invoke divergence damper
      real(r8) precc_thresh     ! Precipitation threshold for PRECCINT and PRECCFRQ
      real(r8) precl_thresh     ! Precipitation threshold for PRECLINT and PRECLFRQ
# 2240 "/data3/work/yuxinzhu/test/model_platform/models/atm/GAMIL2.8_AMIP/src/control/history.F90" 2
...
# 2241 "/data3/work/yuxinzhu/test/model_platform/models/atm/GAMIL2.8_AMIP/src/control/history.F90" 2
...
# 2273 "/data3/work/yuxinzhu/test/model_platform/models/atm/GAMIL2.8_AMIP/src/control/history.F90"
...
# 2377 "/data3/work/yuxinzhu/test/model_platform/models/atm/GAMIL2.8_AMIP/src/control/history.F90"
...
# 2421 "/data3/work/yuxinzhu/test/model_platform/models/atm/GAMIL2.8_AMIP/src/control/history.F90"

!! (wanhui 2003.06.17)

      call wrap_def_var (nfid(t),"lev",nf_double,1,LEVDIM,levvar)
      str = "sigma level at midpoints (1000*(A+B))"
      ...
      call wrap_put_att_text (nfid(t), levvar, "standard_name", "atmosphere_sigma_coordinate")

      call wrap_def_var (nfid(t),"ilev",nf_double,1,ILEVDIM,ilevvar)
      str = "sigma level at interfaces "
      ...
      call wrap_put_att_text (nfid(t), ilevvar, "standard_name", "atmosphere_sigma_coordinate")
...
!
      ...
      call wrap_put_att_text (nfid(T), NF_GLOBAL, "source", "GAMIL")
...
# 2583 "/data3/work/yuxinzhu/test/model_platform/models/atm/GAMIL2.8_AMIP/src/control/history.F90"
...
# 2676 "/data3/work/yuxinzhu/test/model_platform/models/atm/GAMIL2.8_AMIP/src/control/history.F90"

      call wrap_put_var_realx (nfid(t), levvar, sigl)
      call wrap_put_var_realx (nfid(t), ilevvar, sig)
...
!
! Method: If , first gather the data to the master processor.
...
!
      ...
      case (dyn_decomp)
         ...
         if ( dycore_is("LR") )then
# 3065 "/data3/work/yuxinzhu/test/model_platform/models/atm/GAMIL2.8_AMIP/src/control/history.F90"
         else
            coldimin = tape(t)%hlist(f)%field%coldimin
            numowned = coldimin*numlev
            call compute_gsfactors (numowned, numsend, numrecv, displs)
...
!
! Method: For variables which do not need to be gathered () just issue the netcdf call
...
!
            ...
            do f=1,nflds(t)
# 3245 "/data3/work/yuxinzhu/test/model_platform/models/atm/GAMIL2.8_AMIP/src/control/history.F90"
               call dump_field (f, t)
            end do
...
!!    real(r8) divdampn         ! Number of days to invoke divergence damper
      real(r8) precc_thresh     ! Precipitation threshold for PRECCINT and PRECCFRQ
      real(r8) precl_thresh     ! Precipitation threshold for PRECLINT and PRECLFRQ
# 3308 "/data3/work/yuxinzhu/test/model_platform/models/atm/GAMIL2.8_AMIP/src/control/history.F90" 2
...
# 3309 "/data3/work/yuxinzhu/test/model_platform/models/atm/GAMIL2.8_AMIP/src/control/history.F90" 2
!
! Local variables
!
...
# 3457 "/data3/work/yuxinzhu/test/model_platform/models/atm/GAMIL2.8_AMIP/src/control/history.F90"
...
# 3478 "/data3/work/yuxinzhu/test/model_platform/models/atm/GAMIL2.8_AMIP/src/control/history.F90"
      if (masterproc) then
...
# 3536 "/data3/work/yuxinzhu/test/model_platform/models/atm/GAMIL2.8_AMIP/src/control/history.F90"
!
! define variables to label the dimensions, use the same names as the
! dimensions
!
...
# 3580 "/data3/work/yuxinzhu/test/model_platform/models/atm/GAMIL2.8_AMIP/src/control/history.F90"
...
!
         ...
         call wrap_put_att_text (id, nf_global, "source", "GAMIL")
...
# 3861 "/data3/work/yuxinzhu/test/model_platform/models/atm/GAMIL2.8_AMIP/src/control/history.F90"
...
!
! Allocate space for arrays to be written to initial history file.  In  mode,
...
# 3918 "/data3/work/yuxinzhu/test/model_platform/models/atm/GAMIL2.8_AMIP/src/control/history.F90"
      else
...
# 3932 "/data3/work/yuxinzhu/test/model_platform/models/atm/GAMIL2.8_AMIP/src/control/history.F90"
      end if
...
# 4004 "/data3/work/yuxinzhu/test/model_platform/models/atm/GAMIL2.8_AMIP/src/control/history.F90"
...
! output t
!
# 4054 "/data3/work/yuxinzhu/test/model_platform/models/atm/GAMIL2.8_AMIP/src/control/history.F90"
...
!
# 4091 "/data3/work/yuxinzhu/test/model_platform/models/atm/GAMIL2.8_AMIP/src/control/history.F90"
...
!
# 4130 "/data3/work/yuxinzhu/test/model_platform/models/atm/GAMIL2.8_AMIP/src/control/history.F90"
      do m=2,pcnst+pnats
         do j=beglat,endlat
            endi = i1+nlon(j)-1
            numi = nlon(j)
...
# 4164 "/data3/work/yuxinzhu/test/model_platform/models/atm/GAMIL2.8_AMIP/src/control/history.F90"
...
# 4194 "/data3/work/yuxinzhu/test/model_platform/models/atm/GAMIL2.8_AMIP/src/control/history.F90"
      ...
      deallocate (arr3d)
      deallocate (arr2dm)
# 4271 "/data3/work/yuxinzhu/test/model_platform/models/atm/GAMIL2.8_AMIP/src/control/history.F90"
      return
...
!!    real(r8) divdampn         ! Number of days to invoke divergence damper
      real(r8) precc_thresh     ! Precipitation threshold for PRECCINT and PRECCFRQ
      real(r8) precl_thresh     ! Precipitation threshold for PRECLINT and PRECLFRQ
# 4416 "/data3/work/yuxinzhu/test/model_platform/models/atm/GAMIL2.8_AMIP/src/control/history.F90" 2
!-----------------------------------------------------------------------
        ...
        ! boundary layer variable fields
        ! 1. variable fields on the model bottom
        ...
        ! 2. variable fields on the reference level
        call addfld("TREFHT  ", "K       ", 1,    "A", "Temperature at 2m height",                       phys_decomp)
        call addfld("TREFHTMN", "K       ", 1,    "M", "Minimum temperature at 2m height",               phys_decomp)
        call addfld("TREFHTMX", "K       ", 1,    "X", "Maximum temperature at 2m height",               phys_decomp)
        ...
        call addfld("QREFHT  ", "1       ", 1,    "A", "Specific humidity at 2m height",                 phys_decomp)
        call addfld("RHREFHT ", "%       ", 1,    "A", "Relative humidity at 2m height",                 phys_decomp)
        call addfld("RHREFMN ", "%       ", 1,    "M", "Minimum relative humidity at 2m height",         phys_decomp)
        call addfld("RHREFMX ", "%       ", 1,    "X", "Maximum relative humidity at 2m height",         phys_decomp)
        call addfld("WIND10M ", "m/s     ", 1,    "A", "Wind speed on the 10 m under neutral stability", phys_decomp)

        ! radiation variable fields
        ! 1. long wave
        !  (a) surface
        call addfld("FLUS    ", "W/m2    ", 1,    "A", "Long wave upward flux at surface",                    phys_decomp) ! added by DONG Li
        call addfld("FLDS    ", "W/m2    ", 1,    "A", "Long wave downward flux at surface",                  phys_decomp) ! added by DONG Li
        call addfld("FLNS    ", "W/m2    ", 1,    "A", "Long wave net flux at surface",                       phys_decomp)
        call addfld("FLDSC   ", "W/m2    ", 1,    "A", "Long wave clearsky downward flux at surface",         phys_decomp) ! added by DONG Li
        call addfld("FLNSC   ", "W/m2    ", 1,    "A", "Long wave clearsky net flux at surface",              phys_decomp)
        !  (b) model top
        call addfld("FLNT    ", "W/m2    ", 1,    "A", "Long wave net flux at top of model",                  phys_decomp)
        call addfld("FLUT    ", "W/m2    ", 1,    "A", "Long wave upward flux at top of model",               phys_decomp)
        call addfld("FLUTC   ", "W/m2    ", 1,    "A", "Long wave clearsky upward flux at top of model",      phys_decomp)
        call addfld("FLNTC   ", "W/m2    ", 1,    "A", "Long wave clearsky net flux at top of model",         phys_decomp)
        !  (c) atmosphere top
        call addfld("FLUTOA  ", "W/m2    ", 1,    "A", "Long wave upward flux at top of atmosphere",          phys_decomp) ! added by DONG Li
        call addfld("FLUTOAC ", "W/m2    ", 1,    "A", "Long wave clearsky upward flux at top of atmosphere", phys_decomp) ! added by DONG Li
        !  (d) heating rate
        call addfld("QRL     ", "K/s     ", pver, "A", "Long wave heating rate",                              phys_decomp)
        ! 2. short wave
        !  (a) surface
        call addfld("FSUS    ", "W/m2    ", 1,    "A", "Short wave upward flux at surface",            phys_decomp) ! added by DONG Li
        call addfld("FSDS    ", "W/m2    ", 1,    "A", "Short wave downward flux at surface",          phys_decomp)
        call addfld("FSNS    ", "W/m2    ", 1,    "A", "Short wave net flux at surface",               phys_decomp)
        call addfld("FSNSC   ", "W/m2    ", 1,    "A", "Short wave clearsky net flux at surface",      phys_decomp)
        call addfld("FSDSC   ", "W/m2    ", 1,    "A", "Short wave clearsky downward flux at surface", phys_decomp)
        call addfld("FSUSC   ", "W/m2    ", 1,    "A", "Clear sky Short wave upward flux at surface",  phys_decomp) ! added by DONG Li
        !  (b) model top
        call addfld("FSNT    ", "W/m2    ", 1,    "A", "Short wave net flux at top of model",               phys_decomp)
        call addfld("FSNTC   ", "W/m2    ", 1,    "A", "Short wave clearsky net flux at top of model",      phys_decomp)
        !  (c) atmosphere top
        call addfld("FSUTOA  ", "W/m2    ", 1,    "A", "Short wave upward flux at top of atmosphere",       phys_decomp) ! added by DONG Li
        call addfld("FSDTOA  ", "W/m2    ", 1,    "A", "Short wave downward flux at top of atmosphere",     phys_decomp) ! added by DONG Li
        call addfld("FSNTOA  ", "W/m2    ", 1,    "A", "Short wave net flux at top of atmosphere",          phys_decomp)
        call addfld("FSUTOAC ", "W/m2    ", 1,    "A", "Short wave upward flux at top of atmosphere",       phys_decomp) ! added by DONG Li
        call addfld("FSNTOAC ", "W/m2    ", 1,    "A", "Short wave clearsky net flux at top of atmosphere", phys_decomp)
        !  (d) heating rate
        call addfld("QRS     ", "K/s     ", pver, "A", "Short wave heating rate",                           phys_decomp)
      ...
      write(string,"(F5.2)") precc_thresh*3600.*1000.0
      ...
      write(string,"(F5.2)") precl_thresh*3600.*1000.0
...
!
        ...
        ! ======================================================================
        ! add COSP variables
# 4712 "/data3/work/yuxinzhu/test/model_platform/models/atm/GAMIL2.8_AMIP/src/control/history.F90"
!
...
!
      ...
      case (dyn_decomp)
         ...
         if ( dycore_is("LR") )then
# 4845 "/data3/work/yuxinzhu/test/model_platform/models/atm/GAMIL2.8_AMIP/src/control/history.F90"
         else
            masterlist(nfmaster)%field%begver   = 1
            masterlist(nfmaster)%field%endver   = numlev
         endif
...
!!    real(r8) divdampn         ! Number of days to invoke divergence damper
      real(r8) precc_thresh     ! Precipitation threshold for PRECCINT and PRECCFRQ
      real(r8) precl_thresh     ! Precipitation threshold for PRECLINT and PRECLFRQ
# 4907 "/data3/work/yuxinzhu/test/model_platform/models/atm/GAMIL2.8_AMIP/src/control/history.F90" 2
...
# 4908 "/data3/work/yuxinzhu/test/model_platform/models/atm/GAMIL2.8_AMIP/src/control/history.F90" 2
