# 1 "/data3/work/yuxinzhu/test/model_platform/models/atm/GAMIL2.8_AMIP/src/physics/cam1/radclwmx.F90"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/data3/work/yuxinzhu/test/model_platform/models/atm/GAMIL2.8_AMIP/src/physics/cam1/radclwmx.F90"

# 1 "./misc.h" 1
# 2 "/data3/work/yuxinzhu/test/model_platform/models/atm/GAMIL2.8_AMIP/src/physics/cam1/radclwmx.F90" 2

# 1 "./params.h" 1
# 3 "/data3/work/yuxinzhu/test/model_platform/models/atm/GAMIL2.8_AMIP/src/physics/cam1/radclwmx.F90" 2
...
!-----------------------------------------------------------------------
    ...
    integer, parameter :: pverp2 = pver+2
    integer, parameter :: pverp3 = pver+3
    integer, parameter :: pverp4 = pver+4
...
# 45 "/data3/work/yuxinzhu/test/model_platform/models/atm/GAMIL2.8_AMIP/src/physics/cam1/radclwmx.F90" 2
...
# 46 "/data3/work/yuxinzhu/test/model_platform/models/atm/GAMIL2.8_AMIP/src/physics/cam1/radclwmx.F90" 2
...
! Output arguments
    ...
    real(r8), intent(out) :: flnsc(pcols)         ! Clear sky surface cooling
    ...
    do k = ntoplw, pver
        do i = 1, ncol
            qrl(i,k) = (ful(i,k)-fdl(i,k)-ful(i,k+1)+fdl(i,k+1))* &
                        1.0e-4*gravit/((pint(i,k)-pint(i,k+1)))
        end do
    end do
...
! Return 0 above solution domain
    ...
    call outfld('FLUS    ', ful(:,pverp)*1.0e-3,  pcols, lchnk)
    call outfld('FLDS    ', fdl(:,pverp)*1.0e-3,  pcols, lchnk)
    call outfld('FLDSC   ', fsdl(:,pverp)*1.0e-3, pcols, lchnk)
    call outfld('FLUTOA  ', ful(:,1)*1.0e-3,      pcols, lchnk)
    call outfld('FLUTOAC ', fsul(:,1)*1.0e-3,     pcols, lchnk)
