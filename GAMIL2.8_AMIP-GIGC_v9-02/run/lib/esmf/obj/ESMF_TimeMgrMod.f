# 1 "/data3/work/yuxinzhu/test/model_platform/models/libs/esmf/src/Infrastructure/TimeMgmt/ESMF_TimeMgrMod.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/data3/work/yuxinzhu/test/model_platform/models/libs/esmf/src/Infrastructure/TimeMgmt/ESMF_TimeMgrMod.F"
! $Id: ESMF_TimeMgrMod.F,v 1.1.2.5 2002/04/25 17:14:53 dneckels Exp $
...
! !DESCRIPTION:
!     Initializes a new {\tt ESMF\_TimeMgr} object. \!     See the explicit interfaces: 

!
!     \begin{tabular}{p{2in}p{3.5in}}
!     {\tt ESMF\_TimeMgrInitStd}       & general interface to init a time manager \!     {\tt ESMF\_TimeMgrInitNoBaseStd} & general interface to init a time manager,

!                                       with base date == start date \!     {\tt ESMF\_TimeMgrInitIS}        & init a time manager with integer second 

!                                       discretization \!     {\tt ESMF\_TimeMgrInitNoBaseIS}  & init a time manager with integer second

!                                       discretization, base date == start date \!     \end{tabular}  
...
! !DESCRIPTION:
!     Gets a step size. \!     See the explicit interfaces:

!
!     \begin{tabular}{p{2in}p{3.5in}}
!     {\tt ESMF\_TimeMgrGetStepSizeStd} & get step size as time type \!     {\tt ESMF\_TimeMgrGetStepSizeIS}  & get step size as days and seconds \!     \end{tabular}  
...
! !DESCRIPTION:
!     Sets a step size. \!     See the explicit interfaces:

!
!     \begin{tabular}{p{2in}p{3.5in}}
!     {\tt ESMF\_TimeMgrSetStepSizeStd}  & set step size with time type \!     {\tt ESMF\_TimeMgrSetStepSizeIS}   & set step size with days and seconds \!     \end{tabular}  
...
! !DESCRIPTION:
!     Returns the data needed for a restart. \!     See the explicit interfaces:

!
!     \begin{tabular}{p{2in}p{3.5in}}
!     {\tt ESMF\_TimeMgrRestartWriteIS}   & return restart data \!     \end{tabular}  
...
! !DESCRIPTION:
!     Retrieves the restart data and returns a TimeMgr. \!     See the explicit interfaces:

!
!     \begin{tabular}{p{2in}p{3.5in}}
!     {\tt ESMF\_TimeMgrRestartReadIS}   & constructs restart TimeMgr (int) seconds  \!     \end{tabular}  
...
!
!     \begin{tabular}{p{2in}p{3.5in}}
!     {\tt ESMF\_TimeMgrSetCurrDateIS}   & set curr date \!     \end{tabular}  
