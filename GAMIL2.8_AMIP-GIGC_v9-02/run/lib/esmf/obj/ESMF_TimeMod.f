# 1 "/data3/work/yuxinzhu/test/model_platform/models/libs/esmf/src/Infrastructure/TimeMgmt/ESMF_TimeMod.F"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/data3/work/yuxinzhu/test/model_platform/models/libs/esmf/src/Infrastructure/TimeMgmt/ESMF_TimeMod.F"
! $Id: ESMF_TimeMod.F,v 1.1.2.5 2002/04/25 17:14:53 dneckels Exp $
      module ESMF_TimeMod
!===============================================================================
!BOP
! !MODULE: ESMF_TimeMod
...
! !DESCRIPTION:
!     Initializes a {\tt ESMF\_Time} object. \!     See the explicit interfaces:

!
!     \begin{tabular}{p{2in}p{3.5in}}
!     {\tt ESMF\_TimeInitIS}        & initializes a time with days and seconds \!     {\tt ESMF\_TimeInitUndefined} & initializes a time with undefined contents \!     {\tt ESMF\_TimeCopyInit}      & initializes a time based on another time \!     \end{tabular}
...
! !DESCRIPTION:
!     Sets the value of a {\tt ESMF\_Time} object. \!     See the explicit interfaces:

!
!     \begin{tabular}{p{2in}p{3.5in}}
!     {\tt ESMF\_TimeSetIS} & sets a time with days and seconds \!     \end{tabular}
...
! !DESCRIPTION:
!     Gets the value of a {\tt ESMF\_Time} object. \!     See the explicit interfaces:

!
!     \begin{tabular}{p{2in}p{3.5in}}
!     {\tt ESMF\_TimeGetIS} & gets a time of the form days and seconds \!     \end{tabular}
...
! !DESCRIPTION:
!     Increments the value of a {\tt ESMF\_Time} object. \!     See the explicit interfaces:

!
!     \begin{tabular}{p{2in}p{3.5in}}
!     {\tt ESMF\_TimeIncrementIS} & increments a time of the form days and seconds \!     \end{tabular} 
...
! !DESCRIPTION:
!     Decrements the value of a {\tt ESMF\_Time} object. \!     See the explicit interfaces:

!
!     \begin{tabular}{p{2in}p{3.5in}}
!     {\tt ESMF\_TimeDecrementIS} & decrements a time of the form days and seconds \!     \end{tabular}
