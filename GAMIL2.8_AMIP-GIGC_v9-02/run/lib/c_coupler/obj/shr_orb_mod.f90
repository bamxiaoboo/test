# 1 "/data3/work/yuxinzhu/test/GAMIL2.8_AMIP-GIGC_v9-02/run/lib/c_coupler/src/individual_src_files/shr_orb_mod.F90"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/data3/work/yuxinzhu/test/GAMIL2.8_AMIP-GIGC_v9-02/run/lib/c_coupler/src/individual_src_files/shr_orb_mod.F90"
!===============================================================================
! CVS: $Id: shr_orb_mod.F90,v 1.2 2003/11/22 00:27:08 tcraig Exp $
...
!-------------------------------------------------------------------------------
   ...
   if ( log_print ) then
     ...
     write(6,F00) 'CVS revision: $Revision: 1.2 $'
     write(6,F00) 'CVS Tag     : $Name: ccsm3_0_1_beta14 $'
   end if
